...
#define PWM_PULSE_USEC 200000000     // Pulse width in microseconds (50% duty cycle)
...
void main(void) {
    ...
    ret = pwm_configure_capture(
        pwm5_dev,                              // PWM device
        2,                                    // Channel 2
        PWM_CAPTURE_TYPE_PULSE  | PWM_CAPTURE_MODE_CONTINUOUS, // Capture both period and pulse width
